...
// Checks for set cookies, and sets them if not
function setUtmcookies() {
	// If the cookie is undefined (first page visit with no UTM params), create one from the current URL
	...
	// Create variables for UTM params in the URL
	var source = getUrlParameter('utm_source');
	var medium = getUrlParameter('utm_medium');
	var keyword = getUrlParameter('utm_keyword');
	var campaign = getUrlParameter('utm_campaign');

	// Set the URL UTMs as a cookie (even if undefined)
	if (source != undefined) {
